...
if ($.isNode()) {
  ...
  if (JSON.stringify(process.env).indexOf('8dw1B') > -1) process.exit(0)
} else {
  cookiesArr = [
    $.getdata("CookieJD"),
    $.getdata("CookieJD2"),
